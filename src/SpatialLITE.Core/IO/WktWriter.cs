...
/// <summary>
/// Provides methods for writing geometry objects into WKT format.
/// </summary>
public class WktWriter : IDisposable
{
    ...
    /// <summary>
    /// Initializes a new instance of the WktWriter class that writes geometries to file with specific settings.
    /// </summary>
    ...
    {
        var tw = new StringWriter(CultureInfo.InvariantCulture);
        Write(geometry, tw);
    ...
    /// <param name="writer">The output Stream to Append WKT representation to.</param>
    private static void AppendMultiPolygonTaggedText(IMultiPolygon mp, TextWriter writer)
    {
