...
public class WktWriterTests
{
    ...
    public void Constructor_StreamSettings_SetsSettingsAndMakeThemReadOnly()
    {
        ...
        using (var target = new WktWriter(new MemoryStream(), settings))
        {
    ...
    [Fact]
    public void Constructor_PathSettings_SetsSettingsAndMakeThemReadOnly()
    {
        var settings = new WktWriterSettings();
        using (var target = new WktWriter(new MemoryStream(), settings))
        {
    ...
    public void Write_WritesComplexPolygonWitOuterAndInnerRings()
    {
        ...
        var polygon = new Polygon(new CoordinateList(_coordinatesXYZM));
