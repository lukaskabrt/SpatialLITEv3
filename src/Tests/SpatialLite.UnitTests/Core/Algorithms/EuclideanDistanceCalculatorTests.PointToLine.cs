...
{
    public class PointToLine : EuclideanDistanceCalculatorTests
    {
        [Theory]
        ...
        [Theory]
        [InlineData(-5, 2, -2, 3, 2, 1, 2.236067977)]
        [InlineData(-3, 6, -2, 3, 2, 1, 2.236067977)]
        ...
        [InlineData(3, -2, -2, 3, 2, 1, 2.236067977)]
        [InlineData(5, 2, -2, 3, 2, 1, 2.236067977)]
        ...
        [Theory]
        [InlineData(-4, 4, -2, 3, 2, 1, 0)]
        [InlineData(4, 0, -2, 3, 2, 1, 0)]
